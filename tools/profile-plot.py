...
axs[0,3].set_title('heat flux [GB]')
axs[0,4].set_title('particle flux [GB]')
axs[0,5].set_title('total sources')
axs[1,3].set_title(r'$Q(L_{T})$ [GB]')
axs[1,4].set_title(r'$\Gamma(L_n)$ [GB]')
